...
\begin{abstract}
	...
	trivial.
	%
	How this can be done is shown using the example of a Xilinx Zynq UltraScale + MPSoC ZCU102 Evaluation Kit that runs the Android Operating System on it's integrated ARM cores and some image processing filters in the programmable logic.
	%
