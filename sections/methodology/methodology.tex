...
\input{sections/methodology/linuxkernel}
%
...
\input{sections/methodology/uboot}
%
\subsubsection{First Stage Boot Loader}\label{sssec:fsbl}
\input{sections/methodology/fsbl}
%
\subsubsection{Platform Management Unit Firmware}\label{sssec:pmufw}
\input{sections/methodology/pmufw}
%
\subsubsection{Devicetree}\label{sssec:devicetree}
\input{sections/methodology/devicetree}
%
\subsubsection{ARM Trusted Firmware}\label{sssec:atf}
\input{sections/methodology/atf}
%
\subsubsection{Boot Image}\label{sssec:bootimage}
\input{sections/methodology/bootimage}
%
\subsubsection{Android on ZCU102}\label{sssec:androidonzcu102}
\input{sections/methodology/androidzcu102}
%
