...
\newglossaryentry{rp}{
  ...
  text={RP},
  first={\emph{reconfigurable partition (RP)}},
  plural={RPs},
  firstplural={\emph{reconfigurable partitions (RPs)}}
}

\newglossaryentry{bif}{
  name={BIF},
  description={Boot Image Format},
  text={BIF},
  first={\emph{Boot Image Format (BIF)}}
}

\newglossaryentry{dtsi}{
  name={DTSI},
  description={devicetree source include},
  text={DTSI},
  first={\emph{devicetree source include (DTSI)}}
}
...
\newglossaryentry{adb}{
  ...
  text={ADB},
  first={\emph{Android Debug Bridge (ADB)}}
}
...
\newglossaryentry{rest}{
  ...
  text={REST},
  first={\emph{Representational State Transfer (REST)}}
}
...
\newglossaryentry{wsgi}{
  ...
  text={WSGI},
  first={\emph{web server gateway interface (WSGI)}}
}
...
\newglossaryentry{json}{
  ...
  text={JSON},
  first={\emph{JavaScript Object Notation (JSON)}}
}

\newglossaryentry{trd}{
  name={TRD},
  description={Targeted Reference Design},
  text={TRD},
  first={\emph{Targeted Reference Design (TRD)}},
  plural={TRDs},
  firstplural={\emph{Targeted Reference Designs (TRDs)}}
}
